...
# --- Configuration ---
_HOME = Path.home()
DESKTOP = Path(os.environ.get("DESKTOP_PATH", str(_HOME / "Desktop")))
DESKTOP_FALLBACK = _HOME / "Desktop"
GLOBAL_DIARY_ROOT = Path(os.environ.get("GLOBAL_DIARY_ROOT", str(Path(__file__).resolve().parent.parent / "diary")))
OBSIDIAN_DAILY_NOTES = Path(os.environ.get("OBSIDIAN_DAILY_NOTES", str(_HOME / "Documents" / "antigravity" / "40_Daily")))
